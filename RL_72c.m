...
GG1=(1)/(((s^2)+4*s+10)*(s+10)); HH1=zpk([],[],1);  % System 1. GG1 - forward transfer function, HH1 - feedback transfer function
GG2=(s+5.31)/(((s^2)+4*s+10)*(s+10)); HH2=zpk([],[],1);  % System 2. GG2 - forward transfer function, HH2 - feedback transfer function
